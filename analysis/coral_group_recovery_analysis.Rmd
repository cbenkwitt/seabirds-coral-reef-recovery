...
#if want arrows:
     # geom_segment(aes(x = -0.1855, y = -0.3036, xend = -0.5829, yend = 0.6873), colour = "#0067A5", linetype=1)+ #from ord.fit
   # geom_segment(aes(x = -0.5829, y = 0.6873, xend = 0.0565, yend = -0.1825), colour = "#0067A5", linetype=1, arrow =   arrow(length = unit(0.1, "inches")))+ #from ord.fit
     #   geom_segment(aes(x = 0.2258, y = -.1552, xend = 0.0576, yend = 0.3679), colour = "#BE0032", linetype=1)+ #from ord.fit
  #  geom_segment(aes(x = 0.0576, y = 0.3679, xend = 0.3409, yend = -0.2380), colour = "#BE0032", linetype=1, arrow =   arrow(length = unit(0.1, "inches")))+ 
